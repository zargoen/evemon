...
namespace System.Windows.Forms
{
    public static class TreeViewHelper
    {
        ...
        /// <param name="treeView"></param>
        /// <returns></returns>
        public static IEnumerable<TreeNode> GetAllVisibleNodes(TreeView treeView)
        {
        ...
        public static TreeNode GetNodeWithTag(TreeView treeView, Object tag)
        {
        ...
        /// <param name="makeNodeVisible">When true, the node will be made visible</param>
        /// <returns>The selected node, null if this tag was not found</returns>
        public static TreeNode SelectNodeWithTag(TreeView treeView, Object tag, bool makeNodeVisible)
        {
            foreach (var node in GetAllNodes(treeView))
            {
                if (Object.ReferenceEquals(node.Tag, tag))
                {
                    ...
                    if(makeNodeVisible) node.EnsureVisible();
                    return node;
                }
            }
