...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdChatChannelsBlocked :  IEquatable<GetCharactersCharacterIdChatChannelsBlocked>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdChatChannelsBlocked(int? AccessorId = default(int?), AccessorTypeEnum? AccessorType = default(AccessorTypeEnum?), DateTime? EndAt = default(DateTime?), string Reason = default(string))
        {
