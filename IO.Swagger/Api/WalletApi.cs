...
namespace IO.Swagger.Api
{
    ...
    public interface IWalletApi : IApiAccessor
    {
        ...
        float? GetCharactersCharacterIdWallet (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null);
        ...
        ApiResponse<float?> GetCharactersCharacterIdWalletWithHttpInfo (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<float?> GetCharactersCharacterIdWalletAsync (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<float?>> GetCharactersCharacterIdWalletAsyncWithHttpInfo (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null);
        /// <summary>
        /// Get character wallet journal
        /// </summary>
        /// <remarks>
    ...
    public partial class WalletApi : IWalletApi
    {
        ...
        /// <param name="xUserAgent">Client identifier, takes precedence over User-Agent (optional)</param>
        /// <returns>float?</returns>
        public float? GetCharactersCharacterIdWallet (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
             ApiResponse<float?> localVarResponse = GetCharactersCharacterIdWalletWithHttpInfo(characterId, datasource, token, userAgent, xUserAgent);
        ...
        /// <param name="xUserAgent">Client identifier, takes precedence over User-Agent (optional)</param>
        /// <returns>ApiResponse of float?</returns>
        public ApiResponse< float? > GetCharactersCharacterIdWalletWithHttpInfo (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
        ...
        /// <param name="xUserAgent">Client identifier, takes precedence over User-Agent (optional)</param>
        /// <returns>Task of float?</returns>
        public async System.Threading.Tasks.Task<float?> GetCharactersCharacterIdWalletAsync (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
             ApiResponse<float?> localVarResponse = await GetCharactersCharacterIdWalletAsyncWithHttpInfo(characterId, datasource, token, userAgent, xUserAgent);
             return localVarResponse.Data;
        ...
        /// <param name="xUserAgent">Client identifier, takes precedence over User-Agent (optional)</param>
        /// <returns>Task of ApiResponse (float?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<float?>> GetCharactersCharacterIdWalletAsyncWithHttpInfo (int? characterId, string datasource = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
            // verify the required parameter 'characterId' is set
            if (characterId == null)
                throw new ApiException(400, "Missing required parameter 'characterId' when calling WalletApi->GetCharactersCharacterIdWallet");
        ...
        public ApiResponse< List<GetCharactersCharacterIdWalletJournal200Ok> > GetCharactersCharacterIdWalletJournalWithHttpInfo (int? characterId, string datasource = null, long? fromId = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
            ...
            var localVarPath = "/v1/characters/{character_id}/wallet/journal/";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// Returns a corporation&#39;s wallet balance Get a corporation&#39;s wallets  - --  This route is cached for up to 300 seconds
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="corporationId">An EVE corporation ID</param>
        /// <param name="datasource">The server name you would like data from (optional, default to tranquility)</param>
        ...
        /// <summary>
        /// Get corporation wallet journal Retrieve corporation wallet journal  - --  This route is cached for up to 300 seconds
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="corporationId">An EVE corporation ID</param>
        /// <param name="division">Wallet key of the division to fetch journals from</param>
        ...
        public ApiResponse< List<GetCorporationsCorporationIdWalletsDivisionJournal200Ok> > GetCorporationsCorporationIdWalletsDivisionJournalWithHttpInfo (int? corporationId, int? division, string datasource = null, long? fromId = null, string token = null, string userAgent = null, string xUserAgent = null)
        {
            ...
            var localVarPath = "/v1/corporations/{corporation_id}/wallets/{division}/journal/";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
