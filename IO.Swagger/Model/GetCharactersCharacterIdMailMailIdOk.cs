...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdMailMailIdOk :  IEquatable<GetCharactersCharacterIdMailMailIdOk>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdMailMailIdOk(string Body = default(string), int? From = default(int?), List<long?> Labels = default(List<long?>), bool? Read = default(bool?), List<GetCharactersCharacterIdMailMailIdRecipient> Recipients = default(List<GetCharactersCharacterIdMailMailIdRecipient>), string Subject = default(string), DateTime? Timestamp = default(DateTime?))
        {
            this.Body = Body;
            this.From = From;
            this.Labels = Labels;
