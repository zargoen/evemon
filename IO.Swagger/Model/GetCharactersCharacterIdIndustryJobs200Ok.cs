...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdIndustryJobs200Ok :  IEquatable<GetCharactersCharacterIdIndustryJobs200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdIndustryJobs200Ok(int? ActivityId = default(int?), long? BlueprintId = default(long?), long? BlueprintLocationId = default(long?), int? BlueprintTypeId = default(int?), int? CompletedCharacterId = default(int?), DateTime? CompletedDate = default(DateTime?), float? Cost = default(float?), int? Duration = default(int?), DateTime? EndDate = default(DateTime?), long? FacilityId = default(long?), int? InstallerId = default(int?), int? JobId = default(int?), int? LicensedRuns = default(int?), long? OutputLocationId = default(long?), DateTime? PauseDate = default(DateTime?), float? Probability = default(float?), int? ProductTypeId = default(int?), int? Runs = default(int?), DateTime? StartDate = default(DateTime?), long? StationId = default(long?), StatusEnum? Status = default(StatusEnum?), int? SuccessfulRuns = default(int?))
        {
