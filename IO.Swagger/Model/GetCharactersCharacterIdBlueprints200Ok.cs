...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdBlueprints200Ok :  IEquatable<GetCharactersCharacterIdBlueprints200Ok>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates something about this item&#39;s storage location. The flag is used to differentiate between hangar divisions, drone bay, fitting location, and similar.</value>
        ...
        /// Initializes a new instance of the <see cref="GetCharactersCharacterIdBlueprints200Ok" /> class.
        /// </summary>
        /// <param name="ItemId">Unique ID for this item. The ID of an item is stable if that item is not repackaged, stacked, detached from a stack, assembled, or otherwise altered. If an item is changed in one of these ways, then the ID will also change (see notes below). (required).</param>
        /// <param name="LocationFlag">Indicates something about this item&#39;s storage location. The flag is used to differentiate between hangar divisions, drone bay, fitting location, and similar. (required).</param>
        /// <param name="LocationId">References a solar system, station or item_id if this blueprint is located within a container. If an item_id the Character - AssetList API must be queried to find the container using the item_id, from which the correct location of the Blueprint can be derived. (required).</param>
        /// <param name="MaterialEfficiency">Material Efficiency Level of the blueprint, can be any integer between 0 and 10. (required).</param>
        /// <param name="Quantity">Typically will be -1 or -2 designating a singleton item, where -1 is an original and -2 is a copy. It can be a positive integer if it is a stack of blueprint originals fresh from the market (no activities performed on them yet). (required).</param>
        /// <param name="Runs">Number of runs remaining if the blueprint is a copy, -1 if it is an original. (required).</param>
        /// <param name="TimeEfficiency">Time Efficiency Level of the blueprint, can be any even integer between 0 and 20. (required).</param>
        ...
        /// </summary>
        /// <value>Unique ID for this item. The ID of an item is stable if that item is not repackaged, stacked, detached from a stack, assembled, or otherwise altered. If an item is changed in one of these ways, then the ID will also change (see notes below).</value>
        ...
        /// </summary>
        /// <value>References a solar system, station or item_id if this blueprint is located within a container. If an item_id the Character - AssetList API must be queried to find the container using the item_id, from which the correct location of the Blueprint can be derived.</value>
        ...
        /// </summary>
        /// <value>Material Efficiency Level of the blueprint, can be any integer between 0 and 10.</value>
        ...
        /// </summary>
        /// <value>Typically will be -1 or -2 designating a singleton item, where -1 is an original and -2 is a copy. It can be a positive integer if it is a stack of blueprint originals fresh from the market (no activities performed on them yet).</value>
        ...
        /// </summary>
        /// <value>Time Efficiency Level of the blueprint, can be any even integer between 0 and 20.</value>
