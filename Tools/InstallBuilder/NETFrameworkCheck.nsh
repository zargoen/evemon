...
Section "Microsoft .NET Framework v4.0"
  ...
  MessageBox MB_ICONEXCLAMATION|MB_YESNO|MB_DEFBUTTON2 "Microsoft .NET Framework 4.0 is required, and you do not have any version installed.$\nYou must \
  ...
  Call GetDotNETVersion
  Pop $0
  MessageBox MB_ICONEXCLAMATION|MB_YESNO|MB_DEFBUTTON2 "Microsoft .NET Framework 4.0 is required (you only have $0).$\nYou must \
                    install it before continuing.$\nIf you choose to continue, you will need to be connected \
                    to the internet before proceeding.$\nWould you like to continue with the installation?" /SD IDNO IDYES lbl_Confirmed IDNO lbl_Cancelled

  lbl_Cancelled:                  
  Abort "Microsoft .NET Framework 4.0 is required."
  ...
  lbl_continue:
  Banner::show /NOUNLOAD "Installing Microsoft .NET Framework 4.0..."
