...
namespace IO.Swagger.Model
{
    ...
    public partial class GetFwSystems200Ok :  IEquatable<GetFwSystems200Ok>, IValidatableObject
    {
        ...
        public GetFwSystems200Ok(bool? Contested = default(bool?), int? OccupierFactionId = default(int?), int? OwnerFactionId = default(int?), int? SolarSystemId = default(int?), int? VictoryPoints = default(int?), int? VictoryPointsThreshold = default(int?))
        {
