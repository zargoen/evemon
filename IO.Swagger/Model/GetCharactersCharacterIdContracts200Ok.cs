...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdContracts200Ok :  IEquatable<GetCharactersCharacterIdContracts200Ok>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GetCharactersCharacterIdContracts200Ok" /> class.
        /// </summary>
        /// <param name="AcceptorId">Who will accept the contract. If assignee_id is same as acceptorID then character ID else corporation ID (The contract accepted by the corporation) (required).</param>
        ...
        /// </summary>
        /// <value>Who will accept the contract. If assignee_id is same as acceptorID then character ID else corporation ID (The contract accepted by the corporation)</value>
