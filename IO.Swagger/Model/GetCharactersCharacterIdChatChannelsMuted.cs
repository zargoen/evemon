...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdChatChannelsMuted :  IEquatable<GetCharactersCharacterIdChatChannelsMuted>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdChatChannelsMuted(int? AccessorId = default(int?), AccessorTypeEnum? AccessorType = default(AccessorTypeEnum?), DateTime? EndAt = default(DateTime?), string Reason = default(string))
        {
