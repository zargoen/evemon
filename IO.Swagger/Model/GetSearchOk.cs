...
namespace IO.Swagger.Model
{
    ...
    public partial class GetSearchOk :  IEquatable<GetSearchOk>, IValidatableObject
    {
        ...
        /// <param name="Wormhole">wormhole array.</param>
        public GetSearchOk(List<int?> Agent = default(List<int?>), List<int?> Alliance = default(List<int?>), List<int?> Character = default(List<int?>), List<int?> Constellation = default(List<int?>), List<int?> Corporation = default(List<int?>), List<int?> Faction = default(List<int?>), List<int?> Inventorytype = default(List<int?>), List<int?> Region = default(List<int?>), List<int?> Solarsystem = default(List<int?>), List<int?> Station = default(List<int?>), List<int?> Wormhole = default(List<int?>))
        {
            this.Agent = Agent;
        ...
        /// wormhole array
        /// </summary>
        /// <value>wormhole array</value>
        [DataMember(Name="wormhole", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Wormhole: ").Append(Wormhole).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(GetSearchOk input)
        {
            ...
            return 
                ...
                (
                    this.Wormhole == input.Wormhole ||
                    this.Wormhole != null &&
                    this.Wormhole.SequenceEqual(input.Wormhole)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Wormhole != null)
                    hashCode = hashCode * 59 + this.Wormhole.GetHashCode();
                return hashCode;
            }
        }
