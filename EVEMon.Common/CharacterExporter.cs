...
namespace EVEMon.Common
{
    ...
    public static class CharacterExporter
    {
        ...
        private static string ExportAsEFTCHR(Character character, Plan plan)
        {
            ...
            {
                builder.AppendFormat(CultureConstants.DefaultCulture, "UserID={0}{1}", character.Identity.Account.UserID,
                                     Environment.NewLine);
                builder.AppendFormat(CultureConstants.DefaultCulture, "APIKey={0}{1}", character.Identity.Account.APIKey,
                                     Environment.NewLine);
        ...
        private static string ExportAsCCPXML(Character character)
        {
            ...
            XmlDocument doc = LocalXmlCache.GetCharacterXml(character.Name);
