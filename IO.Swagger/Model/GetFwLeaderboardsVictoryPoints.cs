...
namespace IO.Swagger.Model
{
    ...
    public partial class GetFwLeaderboardsVictoryPoints :  IEquatable<GetFwLeaderboardsVictoryPoints>, IValidatableObject
    {
        ...
        public GetFwLeaderboardsVictoryPoints(List<GetFwLeaderboardsActiveTotal1> ActiveTotal = default(List<GetFwLeaderboardsActiveTotal1>), List<GetFwLeaderboardsLastWeek1> LastWeek = default(List<GetFwLeaderboardsLastWeek1>), List<GetFwLeaderboardsYesterday1> Yesterday = default(List<GetFwLeaderboardsYesterday1>))
        {
