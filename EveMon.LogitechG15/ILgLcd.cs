namespace lgLcdClassLibrary
{
    public interface ILgLcd
    {
        ...
        /// </returns>
        int lgLcdConnect(ref NativeMethods.LgLcdConnectContext ctx);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdDisconnect(int connection);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdEnumerate(int connection, int index, out NativeMethods.LgLcdDeviceDesc description);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdOpen(ref NativeMethods.LgLcdOpenContext ctx);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdReadSoftButtons(int device, out int buttons);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdUpdateBitmap(int device, ref NativeMethods.LgLcdBitmap160X43X1 bitmap, uint priority);
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        int lgLcdSetAsLCDForegroundApp(int device, int foregroundYesNoFlag);
    }
}