...
{
    public sealed class LgLcdx64 : ILgLcd
    {
        ...
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdInit")]
        ...
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdDeInit")]
        ...
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdConnect")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdDisconnect")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdEnumerate")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdOpen")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdClose")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdReadSoftButtons")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdUpdateBitmap")]
        ...
        ///     Other (system) error with appropriate error code.
        /// </returns>
        [DllImport("LgLcd.x64.dll", EntryPoint = "lgLcdSetAsLCDForegroundApp")]
