...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdContacts200Ok :  IEquatable<GetCorporationsCorporationIdContacts200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdContacts200Ok(int? ContactId = default(int?), ContactTypeEnum? ContactType = default(ContactTypeEnum?), bool? IsWatched = default(bool?), long? LabelId = default(long?), float? Standing = default(float?))
        {
