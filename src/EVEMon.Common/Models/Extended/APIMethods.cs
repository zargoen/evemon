...
namespace EVEMon.Common.Models.Extended
{
    public static class APIMethods
    {
        ...
        public static IEnumerable<Enum> NonAccountGenericMethods => s_items.OfType<CCPAPIGenericMethods>()
            .Where(method => method != CCPAPIGenericMethods.APIKeyInfo &&
                             method != CCPAPIGenericMethods.CharacterList
                             && !AllSupplementalMethods.Contains(method))
            .Cast<Enum>();
        ...
        public static IEnumerable<Enum> CharacterSupplementalMethods
            => s_items.OfType<CCPAPIGenericMethods>()
                .Where(method => method == CCPAPIGenericMethods.ContractItems ||
                                 ...
                                 method == CCPAPIGenericMethods.Blueprints)
                .Cast<Enum>();
        ...
        public static IEnumerable<Enum> CorporationSupplementalMethods
            => s_items.OfType<CCPAPIGenericMethods>()
                .Where(method => method == CCPAPIGenericMethods.CorporationContractItems ||
                                 ...
                                 method == CCPAPIGenericMethods.CorporationBlueprints)
                .Cast<Enum>();
        ...
        public static IEnumerable<Enum> AllSupplementalMethods
            => CharacterSupplementalMethods.Concat(CorporationSupplementalMethods);
    }
}