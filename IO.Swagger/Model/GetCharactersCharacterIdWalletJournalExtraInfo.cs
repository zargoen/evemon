...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdWalletJournalExtraInfo :  IEquatable<GetCharactersCharacterIdWalletJournalExtraInfo>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdWalletJournalExtraInfo(int? AllianceId = default(int?), int? CharacterId = default(int?), int? ContractId = default(int?), int? CorporationId = default(int?), int? DestroyedShipTypeId = default(int?), int? JobId = default(int?), long? LocationId = default(long?), int? NpcId = default(int?), string NpcName = default(string), int? PlanetId = default(int?), int? SystemId = default(int?), long? TransactionId = default(long?))
        {
