...
namespace EVEMon.SkillPlanner
{
    ...
    /// </summary>
    /// <param name="sender">Source contro</param>
    ...
    public partial class AttributeBarControl : Control
    {
        ...
        /// <summary>
        /// Initializes a new instance of EVEMon.SkillPlanner.AttributeBarControl.
        /// </summary>
        public AttributeBarControl() : base()
        {
            this.SetStyle(
        ...
        private int GetValueAt(Point location)
        {
            ...
            return (location.X - 1) / m_tileWidth + 1;
        }
        ...
        /// Draws a tile.
        /// </summary>
        /// <param name="g">A System.Drawing.Graphics object for drawing</param>
